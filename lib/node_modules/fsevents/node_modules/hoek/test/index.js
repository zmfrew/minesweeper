...
describe('clone()', function () {
    ...
    it('should not convert undefined properties to null', function (done) {
        ...
        expect(_typeof(b.something)).to.equal('undefined');
        done();
    });
...
describe('reach()', function () {
    ...
    it('returns function member', function (done) {
        ...
        expect(_typeof(Hoek.reach(obj, 'i'))).to.equal('function');
        done();
    });
...
describe('ignore()', function () {
    ...
    it('exists', function (done) {
        ...
        expect(_typeof(Hoek.ignore)).to.equal('function');
        done();
    });
});
...
describe('inherits()', function () {
    ...
    it('exists', function (done) {
        ...
        expect(_typeof(Hoek.inherits)).to.equal('function');
        done();
    });
});
...
describe('format()', function () {
    ...
    it('exists', function (done) {
        ...
        expect(_typeof(Hoek.format)).to.equal('function');
        done();
    });
